...
const corsi = [
    ...
    { nome: "GEOMETRIA E ALGEBRA LINEARE", tab: "PRIMO ANNO", year: 1},
    { nome: "FISICA", tab: "PRIMO ANNO", year: 1},
    { nome: "ECONOMIA E ORGANIZZAZIONE AZIENDALE", tab: "PRIMO ANNO", year: 1},
    { nome: "ELETTROTECNICA", tab: "PRIMO ANNO", year: 1},
    { nome: "ANALISI MATEMATICA 2 (PER L'AUTOMAZIONE)", tab: "SECONDO ANNO", year: 2},
    { nome: "FISICA TECNICA E MACCHINE", tab: "SECONDO ANNO", year: 2},
    { nome: "SISTEMI INFORMATICI", tab: "SECONDO ANNO", year: 2},
    { nome: "RETI DI TELECOMUNICAZIONE", tab: "SECONDO ANNO", year: 2},
    { nome: "FONDAMENTI DI AUTOMATICA", tab: "SECONDO ANNO", year: 2},
    { nome: "MODELLISTICA DEI SISTEMI MECCANICI", tab: "SECONDO ANNO", year: 2},
    { nome: "FONDAMENTI DI ELETTRONICA", tab: "SECONDO ANNO", year: 2},
    { nome: "MACCHINE ELETTRICHE E AZIONAMENTI", tab: "TERZO ANNO", year: 3},
    { nome: "MISURE E STRUMENTAZIONE", tab: "TERZO ANNO", year: 3},
    { nome: "SISTEMI A EVENTI DISCRETI", tab: "TERZO ANNO", year: 3},
    { nome: "CONTROLLO DEI PROCESSI", tab: "TERZO ANNO", year: 3},
    { nome: "IMPIANTI INDUSTRIALI E GESTIONE DELLA PRODUZIONE", tab: "TERZO ANNO", year: 3},
    { nome: "FONDAMENTI DI ROBOTICA", tab: "TERZO ANNO", year: 3},
    { nome: "TIROCINIO (INGEGNERIA DELL'AUTOMAZIONE)", tab: "TERZO ANNO", year: 3},
    { nome: "BASI DI DATI 1", tab: "TERZO ANNO", year: 3},
    { nome: "CALCOLO DELLE PROBABILITÀ E STATISTICA", tab: "TERZO ANNO", year: 3},
    { nome: "CHIMICA GENERALE", tab: "TERZO ANNO", year: 3},
    { nome: "ONDE ELETTROMAGNETICHE E MEZZI TRASMISSIVI", tab: "TERZO ANNO", year: 3},
    { nome: "ELEMENTI DI ANALISI FUNZIONALE E TRASFORMATE", tab: "TERZO ANNO", year: 3},
    { nome: "FONDAMENTI DI RICERCA OPERATIVA", tab: "TERZO ANNO", year: 3},
    { nome: "COMPUTER AIDED MANUFATURING", tab: "1ST MASTER", year: "M"},
    { nome: "MODEL IDENTIFICATION AND DATA ANALYSIS", tab: "1ST MASTER", year: "M"},
    { nome: "DYNAMICS OF MECHANICAL SYSTEMS", tab: "1ST MASTER", year: "M"},
    { nome: "ADVANCED AND MULTIVARIABLE CONTROL", tab: "1ST MASTER", year: "M"},
    { nome: "DYNAMICS OF ELECTRICAL MACHINES AND DRIVES", tab: "1ST MASTER", year: "M"},
    { nome: "SOFTWARE ENGINEERING (FOR AUTOMATION)", tab: "2ND MASTER", year: "M"},
    { nome: "AGILE PROJECT MANAGEMENT", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "POWER SYSTEMS: ETHICAL ISSUES AND SOCIAL IMPLICATIONS", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "CRITICAL THINKING", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "EMERGING TECHNOLOGIES AND SOCIETAL CHALLENGES", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "ENGINEERING METHODS SUPPORTING JUSTICE", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "ETHICS FOR TECHNOLOGY", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "HISTORY OF INDUSTRIAL TECHNOLOGICAL INNOVATION", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "IMPLICAZIONI LEGALI DELL'ESERCIZIO DELLA PROFESSIONE (LE RESPONSABILITA' DELL'INGEGNERE)", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "PATENTS AND INTELLECTUAL PROPERTY MANAGEMENT", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "PERSONALITÀ, TEAM BUILDING, LEADERSHIP", tab: "TRANSVERSAL SKILLS", year: "M"},
    { nome: "AUTOMATION AND CONTROL IN AUTONOMOUS VEHICLES", tab: "TAB1", year: "M"},
    { nome: "CONSTRAINED NUMERICAL OPTIMIZATION FOR ESTIMATION AND CONTROL", tab: "TAB1", year: "M"},
    { nome: "CONTROL OF INDUSTRIAL ROBOTS", tab: "TAB1", year: "M"},
    { nome: "CONTROL OF MOBILE ROBOTS", tab: "TAB1", year: "M"},
    { nome: "DATA DRIVEN CONTROL SYSTEM DESIGN", tab: "TAB1", year: "M"},
    { nome: "NETWORKED CONTROL", tab: "TAB1", year: "M"},
    { nome: "NONLINEAR CONTROL", tab: "TAB1", year: "M"},
    { nome: "NUMERICAL ANALYSIS", tab: "TAB1", year: "M"},
    { nome: "ROBUST CONTROL", tab: "TAB1", year: "M"},
    { nome: "SAFETY IN AUTOMATION SYSTEMS", tab: "TAB1", year: "M"},
    { nome: "SYSTEMS THEORY (NONLINEAR DYNAMICS)", tab: "TAB1", year: "M"},
    { nome: "VIBRATION CONTROL AND DIAGNOSTICS OF MECHANICAL SYSTEMS", tab: "TAB1", year: "M"},
    { nome: "CONTROL OF INDUSTRIAL AND MOBILE ROBOTS", tab: "TAB1", year: "M"},
    { nome: "AUTOMATION AND CONTROL IN VEHICLES", tab: "TAB1", year: "M"},
    { nome: "ADVANCED MEASUREMENT SYSTEMS FOR CONTROL APPLICATIONS", tab: "TAB2", year: "M"},
    { nome: "ADVANCED PROCESS CONTROL", tab: "TAB2", year: "M"},
    { nome: "AUTOMATION AND CONTROL IN ELECTRIC AND HYBRID VEHICLES", tab: "TAB2", year: "M"},
    { nome: "AUTOMATION OF ENERGY SYSTEMS", tab: "TAB2", year: "M"},
    { nome: "HIGH-TECH ENTREPRENEURSHIP", tab: "TAB2", year: "M"},
    { nome: "POWER ELECTRONICS AND SUPPLIESP", tab: "TAB2", year: "M"},
    { nome: "PRODUCTION SYSTEMS CONTROL", tab: "TAB2", year: "M"},
    { nome: "PROJECT WORK", tab: "TAB2", year: "M"},
    { nome: "SIMULATION TECHNIQUES AND TOOLS", tab: "TAB2", year: "M"},
    { nome: "MODELLING AND CONTROL OF ENERGY SYSTEMS (C.I.)", tab: "TAB2", year: "M"},
    { nome: "ADDITIVE MANUFACTURING", tab: "TAB3", year: "M"},
    { nome: "ASSET LIFE CYCLE MANAGEMENT", tab: "TAB3", year: "M"},
    { nome: "COMPLESSITÀ NEI SISTEMI E NELLE RETI", tab: "TAB3", year: "M"},
    { nome: "ELECTRONIC SYSTEMS", tab: "TAB3", year: "M"},
    { nome: "ICT FOR CONTROL SYSTEMS ENGINEERING", tab: "TAB3", year: "M"},
    { nome: "IMAGE ANALYSIS AND COMPUTER VISION", tab: "TAB3", year: "M"},
    { nome: "MULTIAGENT SYSTEMS", tab: "TAB3", year: "M"},
    { nome: "OPTICAL MEASUREMENTS", tab: "TAB3", year: "M"},
    { nome: "POWER ELECTRONICS", tab: "TAB3", year: "M"},
    { nome: "SISTEMI PER L'AUTOMAZIONE E LA COMUNICAZIONE INDUSTRIALE", tab: "TAB3", year: "M"},
    { nome: "DISCRETE OPTIMIZATION", tab: "TAB4", year: "M"},
    { nome: "DYNAMICS AND CONTROL OF CHEMICAL PROCESSES", tab: "TAB4", year: "M"},
    { nome: "FORMAL METHODS FOR CONCURRENT AND REAL-TIME SYSTEMS (UIC 545)", tab: "TAB4", year: "M"},
    { nome: "INTERNET OF THINGS", tab: "TAB4", year: "M"},
    { nome: "MACHINE DESIGN", tab: "TAB4", year: "M"},
    { nome: "NATURAL RESOURCES MANAGEMENT", tab: "TAB4", year: "M"},
    { nome: "NONLINEAR OPTIMIZATION", tab: "TAB4", year: "M"},
    { nome: "PERCEPTION, LOCALIZATION AND MAPPING FOR MOBILE ROBOTS", tab: "TAB4", year: "M"},
]
