            ...
            <div className="App">
                <AppBar position="fixed" style={{backgroundColor: "transparent"}} elevation={0}>
                    <Toolbar>
                        ...
                        <Button color="primary" onClick = {() => navigate("/")}>News</Button>
                        <Button color="primary" onClick = {() => navigate("/")}>Dispense</Button>
                        <Button color="primary" onClick = {() => navigate("/")}>Direttivo</Button>
